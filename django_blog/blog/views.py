...
class PostListView(ListView):
    ...
    ordering = ['-date_posted']  # optional: newest first
...
# UpdateView - only logged-in + author can edit
...
# DeleteView - only logged-in + author can delete
...
class PostDetailView(DetailView):
    ...
    def post(self, request, *args, **kwargs):
        """Handle new comment submission inside the post detail view."""
...
class CommentCreateView(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        # attach logged in user and post to comment
        form.instance.author = self.request.user
